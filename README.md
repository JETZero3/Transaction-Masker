...
```
## Table of Contents
- [Getting Started](https://github.com/JETZero3/Transaction-Masker#getting-started)
- [Problems](https://github.com/JETZero3/Transaction-Masker#problems)
- [Requirements](https://github.com/JETZero3/Transaction-Masker#requirements)
	- [Input Requirements](https://github.com/JETZero3/Transaction-Masker#input-requirements)
	- [Masking Requirements](https://github.com/JETZero3/Transaction-Masker#masking-requirements)
- [Approach](https://github.com/JETZero3/Transaction-Masker#approach)
	- [input($argument)](https://github.com/JETZero3/Transaction-Masker#inputargument)
	- [parseFormat($input)](https://github.com/JETZero3/Transaction-Masker#parseformatinput)
		- [Why Format Over String Parsing?](https://github.com/JETZero3/Transaction-Masker#why-format-over-string-parsing)
	- [setRegex($format, &$regex, &$separator, &$delimiter)](https://github.com/JETZero3/Transaction-Masker#setregexformat-regex-separator-delimiter)
	- [parseString($input, $regex)](https://github.com/JETZero3/Transaction-Masker#parsestringinput-regex)
	- [mask()](https://github.com/JETZero3/Transaction-Masker#mask)
		- [maskCardNumber($dictionary)](https://github.com/JETZero3/Transaction-Masker#maskcardnumberdictionary) 
		- [maskExpiryDate($dictionary)](https://github.com/JETZero3/Transaction-Masker#maskexpirydatedictionary) 
		- [maskCVV($dictionary)](https://github.com/JETZero3/Transaction-Masker#maskcvvdictionary) 
		- [Other options](https://github.com/JETZero3/Transaction-Masker#other-options) 
	- [output($format, $dictionary, $separator, $delimiter, $filename)](https://github.com/JETZero3/Transaction-Masker#outputformat-dictionary-separator-delimiter-filename)
- [Supported Formats](https://github.com/JETZero3/Transaction-Masker#supported-formats)
- [Dependencies](https://github.com/JETZero3/Transaction-Masker#dependencies)
